  ...
  return (
    ...
    <div className="px-5 py-5 flex flex-wrap flex-col container">
      ...
      >
        ...
        <div
          className="max-w-sm m-2 bg-white hover:scale-105  rounded-lg shadow-md  bg-gradient-to-br from-blue-400 to-green-400"
        >
          <Link onClick={loadcontent} to="/book">
            <img
              className="rounded-t-lg"
          ...
          <div className="p-5">
            ...
            <p className=" font-normal text-black-700 ">
              ...
              All types of blood test routine & special, Stool examination Urine
              examination
            </p>
          </div>
        </div>
